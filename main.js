...
function check_sketch(){
    counter++;
    document.getElementById("timer_output").innerHTML = counter;
    if (counter > 50000){
        counter = 0;
        timecheck = "done";
    }
    if ((timecheck == "done")||(holderans == "set")){
        timecheck = "";
        holderans = "";
        updateCanvas();
    }
...
function gotResults(error, results){
    if (error){
        ...
        console.log(results);
        drwnsketch = results[0].label;
        document.getElementById("label").innerHTML = "Your Sketch - "+drwnsketch;
        document.getElementById("conf").innerHTML = Math.round(results[0].confidence*100)+"%";
        utterThis = new SpeechSynthesisUtterance(drwnsketch);
...
function gotResult(error, results) {
  ...
  document.getElementById('frequency').innerHTML = 'Confidence - ' + Math.round(results[0].confidence * 100) + '%';
}
...
{
  timer_counter++;
  document.getElementById('timer_output').innerHTML = timer_counter;
